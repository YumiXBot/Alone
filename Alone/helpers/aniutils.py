...
from Alone.utils.db import get_collection
from Alone.utils.google_trans_new import google_translator
from Alone.utils.helper import (
    cflag,
    make_it_rw,
    pos_no,
    return_json_senpai,
...
from Alone import BOT_USERNAME
