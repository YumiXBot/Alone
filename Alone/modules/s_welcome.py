...
from Alone.database.wel_db import *
...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("Alone/resources/bg.jpg")
    ...
    font = ImageFont.truetype('Alone/resources/SwanseaBold-D0ox.ttf', size=40)
    welcome_font = ImageFont.truetype('Alone/resources/SwanseaBold-D0ox.ttf', size=60)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "Alone/resources/profilepic.jpg"
