...
from Alone.database.couples_db import _get_image, get_couple, save_couple
    ...
    try:
       ...
       if not is_selected:
         ...
         try:
            ...
            p1 = "Alone/resources/profilepic.jpg"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "Alone/resources/profilepic.jpg"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("Alone/resources/a.png")
