...
from Alone import app, BOT_USERNAME
from Alone.Config import COMMAND_HANDLER
from Alone.helpers import ImageGeneration, ImageModels, getText
...
async def draw(_,query):
    ...
    if promptdata is None:
        return await query.edit_message_text("something went wrong report it at @AlonesHeaven")
