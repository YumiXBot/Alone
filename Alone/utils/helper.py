    ...
    async def wrapper(_, message: Message):
            ...
            try:
                ...
                if nut-out<1.2:
                    ...
                    if USER_WC[user] == 3:
                        ...
                        await clog('ALONE ', f'UserID: {user}', 'SPAM')
                    if USER_WC[user] == 5:
                        ...
                        await clog('ALONE ', f'UserID: {user}', 'BAN')
                        return
        ...
        try:
            ...
            try:
                ...
                await clog('ALONE ', e, 'FAILURE', msg=message)
    return wrapper
        ...
        if user in OWNER or user==int(cqowner):
            ...
            try:
                ...
                try:
                    ...
                    await clog('ALONE ', e, 'FAILURE', cq=c_q)
        else:
            if cqowner_is_ch:
                if user_valid:
                    try:
